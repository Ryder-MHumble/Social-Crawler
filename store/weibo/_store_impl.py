...
from store.sqlite_store_impl import UnifiedWeiboSqliteStoreImplement


class WeiboSqliteStoreImplement(UnifiedWeiboSqliteStoreImplement):
    """Unified SQLite store for cleaned Weibo data."""
